    ...
    <section id="consultoria" className="section container" style={{ position: 'relative', marginTop: '4rem', marginBottom: '4rem' }}>
      <div className="card-panel animate-slide-up" style={{ textAlign: 'center', padding: '4rem 2rem', border: '1px solid var(--accent-blue)' }}>
        ...
        <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
          <iframe data-tally-src="https://tally.so/embed/ob7111?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1" loading="lazy" width="100%" height="650" frameBorder={0} marginHeight={0} marginWidth={0} title="Diagnóstico Técnico" style={{ border: 'none', display: 'block' }}></iframe>
        </Modal>
      </div>
    </section>
  );
